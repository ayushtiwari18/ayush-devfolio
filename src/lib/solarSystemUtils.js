...
// Only change: async lazy loadThree() instead of static top-level imports
// (static `import * as THREE` causes Next.js SSR crash in ayush-devfolio)
...
// EXACT copy from pixel-persona-flow
