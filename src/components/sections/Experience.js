...
function ExperienceCard({ entry, index, visible }) {
  ...
  return (
    <div
      ...
      className="relative pl-8 before:absolute before:left-[11px] before:top-6 before:bottom-0 before:w-0.5 before:bg-gradient-to-b before:from-primary/60 before:to-primary/10 last:before:hidden"
    >
      {/* Timeline dot */}
      <div className="absolute left-0 top-5 w-6 h-6 rounded-full bg-primary/20 border-2 border-primary flex items-center justify-center shadow-[0_0_12px_hsl(var(--primary)/0.4)]">
      ...
      <div className="bg-card border border-border rounded-2xl p-6 ml-4 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3 mb-3">
          ...
          <span className="flex items-center gap-1.5 text-xs font-medium text-muted-foreground bg-muted px-3 py-1.5 rounded-full whitespace-nowrap font-mono-code">
            <Calendar size={12} />
...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-section px-4 sm:px-6 lg:px-8">
